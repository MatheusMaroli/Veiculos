...
namespace Utils.Notification
{
    ...
    public  abstract class Mail : IDisposable
    {
        ...
        {
            AdicionarEmailOrigem();     
            SetMailDestinations();   
            AdicionarAssuntoEmail();
            AdicionarConteudoEmail();
            BodyHtml();
            Priority();
        }
